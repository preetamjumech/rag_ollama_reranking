...
def process_document(uploaded_file: UploadedFile)-> list[Document]:
    ...
    try:
        ...
        os.unlink(temp_file_path)  # Ensure the temp file is deleted even if an error occurs
...
def query_collections(prompt: str, n_results: int = 10):
    collection = get_vector_collection()
...
if __name__ == "__main__": 
    ...
    if ask and prompt:
        results = query_collections(prompt)
